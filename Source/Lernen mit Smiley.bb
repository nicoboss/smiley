...
Color 0,0,0
ClsColor 2,12,255
Text 640,130,"Sicherungsdatei wurde erstellt!",1
VWait
Delay 1500
Goto Auswahl
EndIf
...
zielpfad$ = ".\"+Name$+".txt"
CopyFile quellpfad$, zielpfad$
Text 640,100,"Spielstand wurde erfolgreich mit der",1
Text 640,160,"letzten Sicherungsdatei überschrieben!",1
Else
Text 640,130,"Sicherungsdatei wurde nicht gefunden!",1
EndIf
Delay 3000
EndIf
SpielstandKopierenA=0
